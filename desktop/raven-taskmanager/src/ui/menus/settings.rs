...
use crate::config::Orientation as PanelOrientation;
...
impl SettingsMenu {
    pub fn new(
        ...
        wifi_btn.connect_clicked(move |_| {
            let _ = tx.blocking_send(PanelCommand::LaunchApp("raven-wifi".into()));
            win.close();
        });
        ...
        bt_btn.connect_clicked(move |_| {
            let _ = tx.blocking_send(PanelCommand::LaunchApp(
        ...
        top_btn.connect_clicked(move |_| {
            let _ = tx.blocking_send(PanelCommand::SetPanelPosition(PanelOrientation::Top));
            win.close();
        });
        ...
        bottom_btn.connect_clicked(move |_| {
            let _ = tx.blocking_send(PanelCommand::SetPanelPosition(PanelOrientation::Bottom));
            win.close();
        });
        ...
        left_btn.connect_clicked(move |_| {
            let _ = tx.blocking_send(PanelCommand::SetPanelPosition(PanelOrientation::Left));
            win.close();
        });
        ...
        right_btn.connect_clicked(move |_| {
            let _ = tx.blocking_send(PanelCommand::SetPanelPosition(PanelOrientation::Right));
            win.close();
        });
